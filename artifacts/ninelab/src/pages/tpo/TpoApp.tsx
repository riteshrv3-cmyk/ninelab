    ...
    return (
      <FullScreen>
        <div>
          ...
          <p className="text-[13px] text-ink-muted mt-1 max-w-sm">Use the email your ninelab admin allowlisted for your college.</p>
    ...
    return (
      <FullScreen>
        <div>
          ...
          <p className="text-[13px] text-ink-muted mt-1 max-w-sm">Ask your ninelab admin to add your email to your college. Once added, sign out and back in.</p>
          <a href={`${basePath}/`} className="inline-block mt-4 text-[13px] font-bold text-brand">Back to ninelab →</a>
        </div>
      </FullScreen>
    );
  }
